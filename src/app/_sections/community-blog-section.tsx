  ...
  return (
    <div className=''>
      ...
      <div className='grid grid-cols-4 grid-rows-2 gap-2'>
        ...
        <BlogCard className='col-span-2' />
        <BlogCard className='col-span-3 row-start-2' />
        <VideoEmbed className='col-span-2' placeholderImage={blogVideoImg[0]} />
        <VideoEmbed className='col-span-2' placeholderImage={blogVideoImg[1]} />
        <GetStartingBox className='col-start-4 row-start-2' />
      </div>
    </div>
  );
};
